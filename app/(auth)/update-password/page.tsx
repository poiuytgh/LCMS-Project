...
export default function UpdatePasswordPage() {
  ...
  const [busy, setBusy] = useState(true);       // ตรวจสอบลิงก์/เซสชัน
  const [saving, setSaving] = useState(false);  // กำลังบันทึกรหัสผ่าน

  // พยายามตั้ง session จาก hash (#access_token, #refresh_token) กรณีกดมาจากอีเมล
  useEffect(() => {
    (async () => {
      try {
